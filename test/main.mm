// This is just for testing on both iOS and macOS without storyboards and outside xcode, don't structure your code this way!
...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    win = [[NSWindow alloc]initWithContentRect:NSMakeRect(40, 40, 800, 600) styleMask:(NSWindowStyleMaskClosable | NSWindowStyleMaskTitled) backing:NSBackingStoreBuffered defer:NO];
